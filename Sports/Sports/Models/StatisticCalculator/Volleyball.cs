...
{
    public class Volleyball : IStatisticCalculator
    {
        public void CalculateStatisticsTeam1(List<Result> team1Matches, List<Statistic> statisticsTeam1, Result result, double teamMatches, double teamMatchesWithWins, string sport)
        {
            if (sport == "Volleyball")
            {
                foreach (var team1 in statisticsTeam1)
                {
                    ...
                    if (team1.StatisticType.Name == "Sets")
                    {
                    ...
                    {
                        if (result.Team1Result == 3 && result.Team2Result == 0 && result.Team1Result > result.Team2Result || result.Team1Result == 3 && result.Team2Result == 1 && result.Team1Result > result.Team2Result)
                        {
                            team1.Value += 3;
                        }
                        else if (result.Team1Result == 3 && result.Team2Result == 2 && result.Team1Result > result.Team2Result)
                        {
                            team1.Value += 2;
                        }
                        else if (result.Team1Result == 2 && result.Team2Result == 3 && result.Team1Result < result.Team2Result)
                        {
                            team1.Value += 1;
                        }
                        else if (result.Team1Result == 1 && result.Team2Result == 3 && result.Team1Result < result.Team2Result || result.Team1Result == 0 && result.Team2Result == 3 && result.Team1Result < result.Team2Result)
                        {
                            team1.Value += 0;
                        }
                    }
        ...
        public void CalculateStatisticsTeam2(List<Result> team2Matches, List<Statistic> statisticsTeam2, Result result, double teamMatches, double teamMatchesWithWins, string sport)
        {
            if (sport == "Volleyball")
            {
                foreach (var team2 in statisticsTeam2)
                {
                    ...
                    if (team2.StatisticType.Name == "Sets")
                    {
                    ...
                    {
                        if (result.Team2Result == 3 && result.Team1Result == 0 && result.Team2Result > result.Team1Result || result.Team2Result == 3 && result.Team1Result == 1 && result.Team2Result > result.Team1Result)
                        {
                            team2.Value += 3;
                        }
                        else if (result.Team2Result == 3 && result.Team1Result == 2 && result.Team2Result > result.Team1Result)
                        {
                            team2.Value += 2;
                        }
                        else if (result.Team2Result == 2 && result.Team1Result == 3 && result.Team2Result < result.Team1Result)
                        {
                            team2.Value += 1;
                        }
                        else if (result.Team2Result == 1 && result.Team1Result == 3 && result.Team2Result < result.Team1Result || result.Team2Result == 0 && result.Team1Result == 3 && result.Team2Result < result.Team1Result)
                        {
                            team2.Value += 0;
                        }
                    }
